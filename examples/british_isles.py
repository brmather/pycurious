...
try:
    ...
    np.savez_compressed(filedir+'EMAG2_V3_20170530.npz', data=mag_data)
...
## Mapping
We need to grid our points again, this time back into WGS84
"""



xyc_list = np.column_stack([xc_list, yc_list])
curie_xy = ztOpt + dzOpt

gtextent = [lonmin+2.5, lonmax-2, latmin+0.5, latmax-0.5]
curie_depth = pycurious.grid(xyc_list, curie_xy, gtextent, shape=(500,500), epsg_in=2157, epsg_out=4326)
